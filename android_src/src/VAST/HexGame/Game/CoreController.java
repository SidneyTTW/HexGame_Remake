...
public class CoreController implements CoreControllerInterface {
   ...
   */
  @Override
  public void rotateABallTo(Ball ball, MyPoint toPos, MyPoint centerPos,
      int steps, boolean forceFillDirection, int distance) {
    if (ball == null)
      return;
   ...
   */
  @Override
  public void translateABallTo(Ball ball, MyPoint toPos, int steps,
      boolean plain) {
    Vector<MyPoint> stopPositions = new Vector<MyPoint>();
