...
public class PuzzleChooseTypeWidget extends AbstractSimpleWidget {
  ...
  public PuzzleChooseTypeWidget() {
    ...
    for (int i = 0; i < 3; ++i) {
      ...
      item.setImageSeries(SourceManagement.PuzzleTypeFile[i]);
  ...
  public void buttonClicked(int indexOfTheButton) {
    ...
    case Unite:
    case Lock:
      PuzzleChooseStageWidget stageWidget = new PuzzleChooseStageWidget(
          indexOfTheButton, false);
  ...
  public void paint(MyGraphics g) {
    BasicPainter.paintBackGround(BasicPainter.PuzzleMenu, g, width(), height(),
        frame);
    super.paint(g);
  }
