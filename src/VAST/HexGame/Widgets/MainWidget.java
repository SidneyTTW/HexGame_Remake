 ...
 *
 */
public class MainWidget extends JPanel implements MouseListener, MouseMotionListener, MainWidgetInterface {
  /**
   * @see VAST.HexGame.Widgets.MainWidgetInterface#changeControl(VAST.HexGame.Widgets.WidgetInterface, boolean)
   * 
  ...
  public void changeControl(WidgetInterface target, boolean popMySelf) {
    ...
    if (!widgets.isEmpty()) {
      ...
      lastImage = new BufferedImage(topWidget.width(), topWidget.height(), BufferedImage.TYPE_4BYTE_ABGR);
